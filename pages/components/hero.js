        ...
        <div className="font-serif">
            <div className='max-w-[850px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center uppercase'>
                ...
                <div className="flex mx-auto">
                    ...
                    <button className="lg:text-lg md:text-md sm:text-sm text-xs sm:p-3 bg-[#00df9a] rounded-3xl my-auto p-2 font-bold hover:scale-125 duration-100 font-serif">Contact Me</button>
                </div>
            </div>
        </div>
